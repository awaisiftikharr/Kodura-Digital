...
export const metadata: Metadata = {
  ...
  description: "General terms and conditions template for Kodura Digital. Please review before launch.",
      ...
      <section className="mx-auto max-w-4xl px-4 py-20 sm:px-6 lg:px-8">
        ...
        <Card className="mt-10">
          <div className="prose space-y-5 text-slate-300">
            ...
            <p>This is a general template and should be reviewed by legal counsel before launch.</p>
          </div>
        </Card>
      </section>
    </PageShell>
