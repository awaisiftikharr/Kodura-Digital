...
`RESEND_FROM_EMAIL` must use a domain verified in Resend. Without these email variables, the contact forms intentionally return a configuration error instead of claiming that an inquiry was delivered.
